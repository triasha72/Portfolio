...
def build() -> None:
    ...
    role = ParagraphStyle(
        ...
        leading=11.2, textColor=black, spaceBefore=3.2, spaceAfter=2,
        keepWithNext=True,
    )
    body = ParagraphStyle(
    ...
    story = [
        ...
        Paragraph("Project EAGLE | Vehicle Grand Challenge with RIC Enterprise | Sep 2025 – Present", role),
        Paragraph("Developed sizing and synthesis tooling, passenger layout, AutoCAD cabin geometry, and requirements for the Eco-friendly Airborne Global Luxury Ekranoplan.", body),
        Paragraph("Project GREEN TEA | Sustainable aviation modeling | Sep 2025 – Present", role),
        Paragraph("Developed a techno-economic framework for forest-residue sustainable aviation fuel and bioenergy, including jobs, CO2 impacts, a GREET surrogate, and forest-health modeling.", body),
        ...
        Spacer(1, 5),
        Paragraph("LEADERSHIP AND HACKATHONS", section),
