...
def build() -> None:
    ...
    story = [
        ...
        Paragraph("Compared a pointwise MLP, MeshGraphNet-style GNN, and point neural operator across three matched seeds and all 200 official AirfRANS interpolation test meshes per treatment; no architecture won every field and force metric.", bullet, bulletText="•"),
