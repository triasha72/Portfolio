...
def build() -> None:
    ...
    story = [
        ...
        Paragraph("Helped organize a campus hackathon for student teams and technical events.", bullet, bulletText="•"),
        Paragraph("Hackathon Participant | SRM Institute of Science and Technology | Sep 2019", body),
        Paragraph("Worked in a five-member team on a sustainable-city modeling project.", bullet, bulletText="•"),
