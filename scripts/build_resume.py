...
def build() -> None:
    ...
    story = [
        ...
        Paragraph("Confirmed the uncertainty method on separate UCI concrete data. Test R² was 0.902, and normalized 90% intervals covered 95.83% of held-out mixture groups.", bullet, bulletText="•"),
        ...
        Paragraph("Added 101 mapped hospitals, clinics, fire stations, and shelters, then carried ACS population uncertainty through the accessibility calculations. Observed traffic calibration is still pending.", bullet, bulletText="•"),
