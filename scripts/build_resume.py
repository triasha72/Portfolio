...
def build() -> None:
    ...
    story = [
        ...
        Paragraph("IntegrityBench | Moderation evaluation and release controls | 2026", role),
        ...
        Paragraph("AeroSynth-Eval | Synthetic inspection-image evaluation | 2026", role),
        Paragraph("Evaluated synthetic aircraft-inspection image data with reproducible dataset splits and reported where model performance was strong, limited, or still pending validation.", bullet, bulletText="•"),
        Paragraph("Equity Backtest | Walk-forward signal evaluation | 2026", role),
        Paragraph("Built a cross-sectional equity-signal backtest using walk-forward evaluation, trading costs, and safeguards against common look-ahead and selection biases.", bullet, bulletText="•"),
